...
🛠️ Tech Stack
LayerTechnologiesBackendPython, FastAPI, PandasML EngineScikit-learn, Isolation Forest, Z-Score StatisticsFrontendReact.js, Recharts, Tailwind CSSDatabaseSQLite / PostgreSQL, RedisDeploymentDocker, Edge-compatible
